        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "- Start with get_guided_publish_requirements and follow that guidance instead of inventing a parallel flow.",
                "- Use get_launch_best_practices before the final publish step so launch polish is part of the plan, not an afterthought.",
        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "- Start with get_launch_best_practices.",
        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "- Prefer get_publish_readiness before deeper operation-inspection tools.",
                "- Use get_import_operation, watch_operation, explain_operation_failure, or list_import_operations only when they are genuinely needed for recovery.",
